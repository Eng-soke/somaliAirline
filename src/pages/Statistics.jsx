...
function Statistics() {
  ...
  return (
    <div>
      ...
      <div className={` ml-0 ${collapsed ? 'ml-[100px]' : 'lg:ml-[20%]'} pt-10 px-4 `}>
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Pie Chart (Flight Share) */}
            <div className="bg-white p-6  hover:bg-black hover:text-white rounded-lg shadow">
            ...
            {/* Flight Schedule */}
            <div className="bg-white p-6 rounded-lg shadow col-span-1 md:col-span-2 mt-5">
